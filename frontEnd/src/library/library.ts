...
export class Library {
    ...
    viewBooks() {
        ...
        this.http.get('http://52.36.37.141:8000/books/', { headers: contentHeaders })
            .subscribe(
            response => {
    ...
    viewMovies() {
        ...
        this.type = 'movie';
        contentHeaders.append('WWW-Authenticate', localStorage.getItem('jwt'));
        this.http.get('http://52.36.37.141:8000/movies/', { headers: contentHeaders })
            .subscribe(
            response => {
                var jsonResponse = response.json();
                console.log('response received!', jsonResponse);
    ...
    viewMusic() {
        ...
        contentHeaders.append('WWW-Authenticate', localStorage.getItem('jwt'));
        //contentHeaders.append('X-CSRFToken', this.getCookie('csrftoken'));
        this.http.get('http://52.36.37.141:8000/musics/', { headers: contentHeaders })
            .subscribe(
            response => {
                var jsonResponse = response.json();
                console.log('response received!', jsonResponse);
    ...
    sendDelete(data_string) {
        ...
        var url = 'http://52.36.37.141:8000/' + this.type + 's/';
